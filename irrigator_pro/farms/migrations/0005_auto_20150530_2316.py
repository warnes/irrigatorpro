...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='probereading',
            name='irrigation',
            field=models.DecimalField(default=0.0, verbose_name=b'irrigation in inches', max_digits=4, decimal_places=2),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='probereading',
        ...
        migrations.AddField(
            model_name='probereading',
            name='rain',
            field=models.DecimalField(default=0.0, verbose_name=b'rainfall in inches', max_digits=4, decimal_places=2),
            preserve_default=True,
        ),
        migrations.AddField(
