...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CropSeasonEvent', fields ['crop_season', 'field', 'crop_event']
        db.create_unique(u'farms_cropseasonevent', ['crop_season_id', 'field_id', 'crop_event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CropSeasonEvent', fields ['crop_season', 'field', 'crop_event']
        db.delete_unique(u'farms_cropseasonevent', ['crop_season_id', 'field_id', 'crop_event_id'])
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 3, 0, 0)'})
        },
        u'farms.cropseasonevent': {
            'Meta': {'ordering': "['crop_season__season_start_date', 'crop_event']", 'unique_together': "(('crop_season', 'field', 'crop_event'),)", 'object_name': 'CropSeasonEvent'},
            'cdate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 3, 0, 0)'}),
