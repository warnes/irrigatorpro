...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WaterRegister'
        db.create_table(u'farms_waterregister', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('cuser', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'farms_waterregister_cusers', to=orm['auth.User'])),
            ('mdate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('muser', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'farms_waterregister_musers', to=orm['auth.User'])),
            ('crop_season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farms.CropSeason'])),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farms.Field'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('crop_stage', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ...
        # Adding unique constraint on 'WaterRegister', fields ['crop_season', 'field', 'date']
        db.create_unique(u'farms_waterregister', ['crop_season_id', 'field_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'WaterRegister', fields ['crop_season', 'field', 'date']
        db.delete_unique(u'farms_waterregister', ['crop_season_id', 'field_id', 'date'])

        # Deleting model 'WaterRegister'
        db.delete_table(u'farms_waterregister')
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'})
        },
