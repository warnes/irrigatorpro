...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CropEvent.do_not_irrigate'
        db.add_column(u'farms_cropevent', 'do_not_irrigate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WaterRegister.max_temp_2in'
        db.add_column(u'farms_waterregister', 'max_temp_2in',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=0, blank=True),
                      keep_default=False)

        # Adding field 'WaterRegister.do_not_irrigate'
        db.add_column(u'farms_waterregister', 'do_not_irrigate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WaterRegister.max_observed_temp_2in'
        db.add_column(u'farms_waterregister', 'max_observed_temp_2in',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CropEvent.do_not_irrigate'
        db.delete_column(u'farms_cropevent', 'do_not_irrigate')

        # Deleting field 'WaterRegister.max_temp_2in'
        db.delete_column(u'farms_waterregister', 'max_temp_2in')

        # Deleting field 'WaterRegister.do_not_irrigate'
        db.delete_column(u'farms_waterregister', 'do_not_irrigate')

        # Deleting field 'WaterRegister.max_observed_temp_2in'
        db.delete_column(u'farms_waterregister', 'max_observed_temp_2in')
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 7, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 6, 0, 0)'})
        },
        u'farms.cropseasonevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 6, 0, 0)'}),
