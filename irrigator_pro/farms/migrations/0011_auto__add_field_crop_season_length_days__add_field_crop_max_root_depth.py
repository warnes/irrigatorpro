...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Crop.season_length_days'
        db.add_column(u'farms_crop', 'season_length_days',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=154),
                      keep_default=False)

        # Adding field 'Crop.max_root_depth'
        db.add_column(u'farms_crop', 'max_root_depth',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=18),
                      keep_default=False)

        # Adding field 'CropSeason.season_end_date'
        db.add_column(u'farms_cropseason', 'season_end_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 11, 0, 0)),
                      keep_default=False)

        if not db.dry_run:
            for cropseason in orm.CropSeason.objects.all():
                cropseason.season_end_date = cropseason.season_start_date + datetime.timedelta(days=154)


    def backwards(self, orm):
        # Deleting field 'Crop.season_length_days'
        db.delete_column(u'farms_crop', 'season_length_days')

        # Deleting field 'Crop.max_root_depth'
        db.delete_column(u'farms_crop', 'max_root_depth')

        # Deleting field 'CropSeason.season_end_date'
        db.delete_column(u'farms_cropseason', 'season_end_date')
    ...
    models = {
        ...
        u'farms.crop': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_root_depth': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 11, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)'})
        },
        u'farms.cropseasonevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)'}),
