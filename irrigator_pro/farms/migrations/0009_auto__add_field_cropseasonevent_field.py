...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CropSeasonEvent.field'
        db.add_column(u'farms_cropseasonevent', 'field',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=7, to=orm['farms.Field']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CropSeasonEvent.field'
        db.delete_column(u'farms_cropseasonevent', 'field_id')
