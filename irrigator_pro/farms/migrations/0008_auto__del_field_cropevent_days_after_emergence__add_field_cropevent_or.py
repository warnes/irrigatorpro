...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CropEvent.days_after_emergence'
        db.delete_column(u'farms_cropevent', 'days_after_emergence')

        # Adding field 'CropEvent.order'
        db.add_column(u'farms_cropevent', 'order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CropEvent.duration'
        db.add_column(u'farms_cropevent', 'duration',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CropEvent.key_event'
        db.add_column(u'farms_cropevent', 'key_event',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'CropEvent', fields ['crop', 'order']
        db.create_unique(u'farms_cropevent', ['crop_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'CropEvent', fields ['crop', 'order']
        db.delete_unique(u'farms_cropevent', ['crop_id', 'order'])


        # User chose to not deal with backwards NULL issues for 'CropEvent.days_after_emergence'
        raise RuntimeError("Cannot reverse this migration. 'CropEvent.days_after_emergence' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CropEvent.days_after_emergence'
        db.add_column(u'farms_cropevent', 'days_after_emergence',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(),
                      keep_default=False)

        # Deleting field 'CropEvent.order'
        db.delete_column(u'farms_cropevent', 'order')

        # Deleting field 'CropEvent.duration'
        db.delete_column(u'farms_cropevent', 'duration')

        # Deleting field 'CropEvent.key_event'
        db.delete_column(u'farms_cropevent', 'key_event')
