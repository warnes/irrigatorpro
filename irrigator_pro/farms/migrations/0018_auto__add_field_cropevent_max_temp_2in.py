...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CropEvent.max_temp_2in'
        db.add_column(u'farms_cropevent', 'max_temp_2in',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CropEvent.max_temp_2in'
        db.delete_column(u'farms_cropevent', 'max_temp_2in')
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 6, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 5, 0, 0)'})
        },
        u'farms.cropseasonevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 5, 0, 0)'}),
