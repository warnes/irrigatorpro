...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProbeReading.source'
        db.add_column(u'farms_probereading', 'source',
                      self.gf('django.db.models.fields.CharField')(default='User', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProbeReading.source'
        db.delete_column(u'farms_probereading', 'source')
