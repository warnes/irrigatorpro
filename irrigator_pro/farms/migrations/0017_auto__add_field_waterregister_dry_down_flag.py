...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WaterRegister.dry_down_flag'
        db.add_column(u'farms_waterregister', 'dry_down_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WaterRegister.dry_down_flag'
        db.delete_column(u'farms_waterregister', 'dry_down_flag')
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 27, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 26, 0, 0)'})
        },
