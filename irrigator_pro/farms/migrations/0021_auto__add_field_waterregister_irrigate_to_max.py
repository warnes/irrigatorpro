...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WaterRegister.irrigate_to_max'
        db.add_column(u'farms_waterregister', 'irrigate_to_max',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WaterRegister.irrigate_to_max'
        db.delete_column(u'farms_waterregister', 'irrigate_to_max')
