...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WaterHistory.farm'
        db.delete_column(u'farms_waterhistory', 'farm_id')

        # Deleting field 'Planting.farm'
        db.delete_column(u'farms_planting', 'farm_id')

        # Deleting field 'Probe.farm'
        db.delete_column(u'farms_probe', 'farm_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WaterHistory.farm'
        raise RuntimeError("Cannot reverse this migration. 'WaterHistory.farm' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'WaterHistory.farm'
        db.add_column(u'farms_waterhistory', 'farm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farms.Farm']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Planting.farm'
        raise RuntimeError("Cannot reverse this migration. 'Planting.farm' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Planting.farm'
        db.add_column(u'farms_planting', 'farm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farms.Farm']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Probe.farm'
        raise RuntimeError("Cannot reverse this migration. 'Probe.farm' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Probe.farm'
        db.add_column(u'farms_probe', 'farm',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farms.Farm']),
                      keep_default=False)
