...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CropEvent.irrigation_message'
        db.add_column(u'farms_cropevent', 'irrigation_message',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CropEvent.irrigation_message'
        db.delete_column(u'farms_cropevent', 'irrigation_message')
