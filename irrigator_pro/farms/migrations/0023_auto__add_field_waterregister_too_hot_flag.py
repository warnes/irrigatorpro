...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WaterRegister.too_hot_flag'
        db.add_column(u'farms_waterregister', 'too_hot_flag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WaterRegister.too_hot_flag'
        db.delete_column(u'farms_waterregister', 'too_hot_flag')
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 8, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 7, 0, 0)'})
        },
        u'farms.cropseasonevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 7, 0, 0)'}),
