...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'farms.planting': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'planting_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 24, 0, 0)'})
        },
        u'farms.plantingevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 24, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mdate': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
