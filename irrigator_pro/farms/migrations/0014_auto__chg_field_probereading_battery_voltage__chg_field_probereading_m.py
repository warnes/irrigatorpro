...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProbeReading.battery_voltage'
        db.alter_column(u'farms_probereading', 'battery_voltage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=2))

        # Changing field 'ProbeReading.file_date'
        db.alter_column(u'farms_probereading', 'file_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ProbeReading.minutes_awake'
        db.alter_column(u'farms_probereading', 'minutes_awake', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'ProbeReading.battery_percent'
        db.alter_column(u'farms_probereading', 'battery_percent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'ProbeReading.thermocouple_2_temp'
        db.alter_column(u'farms_probereading', 'thermocouple_2_temp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'ProbeReading.circuit_board_temp'
        db.alter_column(u'farms_probereading', 'circuit_board_temp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'ProbeReading.thermocouple_1_temp'
        db.alter_column(u'farms_probereading', 'thermocouple_1_temp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ProbeReading.battery_voltage'
        db.alter_column(u'farms_probereading', 'battery_voltage', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=2))

        # Changing field 'ProbeReading.file_date'
        db.alter_column(u'farms_probereading', 'file_date', self.gf('django.db.models.fields.DateField')(default=0))

        # Changing field 'ProbeReading.minutes_awake'
        db.alter_column(u'farms_probereading', 'minutes_awake', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0))

        # Changing field 'ProbeReading.battery_percent'
        db.alter_column(u'farms_probereading', 'battery_percent', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2))

        # Changing field 'ProbeReading.thermocouple_2_temp'
        db.alter_column(u'farms_probereading', 'thermocouple_2_temp', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2))

        # Changing field 'ProbeReading.circuit_board_temp'
        db.alter_column(u'farms_probereading', 'circuit_board_temp', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2))

        # Changing field 'ProbeReading.thermocouple_1_temp'
        db.alter_column(u'farms_probereading', 'thermocouple_1_temp', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 15, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 14, 0, 0)'})
        },
