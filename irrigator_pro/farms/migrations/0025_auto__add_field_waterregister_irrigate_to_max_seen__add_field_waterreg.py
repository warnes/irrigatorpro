...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WaterRegister.irrigate_to_max_seen'
        db.add_column(u'farms_waterregister', 'irrigate_to_max_seen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WaterRegister.irrigate_to_max_achieved'
        db.add_column(u'farms_waterregister', 'irrigate_to_max_achieved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WaterRegister.days_to_irrigation'
        db.add_column(u'farms_waterregister', 'days_to_irrigation',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WaterRegister.irrigate_to_max_seen'
        db.delete_column(u'farms_waterregister', 'irrigate_to_max_seen')

        # Deleting field 'WaterRegister.irrigate_to_max_achieved'
        db.delete_column(u'farms_waterregister', 'irrigate_to_max_achieved')

        # Deleting field 'WaterRegister.days_to_irrigation'
        db.delete_column(u'farms_waterregister', 'days_to_irrigation')
    ...
    models = {
        ...
        u'farms.cropevent': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'do_not_irrigate': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 8, 6, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 5, 0, 0)'})
        },
        u'farms.cropseasonevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 5, 0, 0)'}),
        ...
        u'farms.waterregister': {
            ...
            'daily_water_use': ('django.db.models.fields.DecimalField', [], {'max_digits': '3', 'decimal_places': '2'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'days_to_irrigation': ('django.db.models.fields.SmallIntegerField', [], {'default': '-1'}),
            'do_not_irrigate': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'irrigate_to_max': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'irrigate_to_max_achieved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'irrigate_to_max_seen': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'irrigation': ('django.db.models.fields.DecimalField', [], {'max_digits': '3', 'decimal_places': '2', 'blank': 'True'}),
            'max_observed_temp_2in': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '1', 'blank': 'True'}),
            'max_temp_2in': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '0', 'blank': 'True'}),
            'mdate': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'too_hot_flag': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
