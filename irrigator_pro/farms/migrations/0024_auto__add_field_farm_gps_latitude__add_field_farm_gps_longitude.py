...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Farm.gps_latitude'
        db.add_column(u'farms_farm', 'gps_latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Farm.gps_longitude'
        db.add_column(u'farms_farm', 'gps_longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Farm.gps_latitude'
        db.delete_column(u'farms_farm', 'gps_latitude')

        # Deleting field 'Farm.gps_longitude'
        db.delete_column(u'farms_farm', 'gps_longitude')
    ...
    models = {
        ...
        u'farms.cropseason': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'season_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 9, 0, 0)'}),
            'season_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 8, 0, 0)'})
        },
        u'farms.cropseasonevent': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 8, 0, 0)'}),
