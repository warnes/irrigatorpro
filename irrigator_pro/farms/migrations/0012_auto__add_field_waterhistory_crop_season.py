...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WaterHistory.crop_season'
        db.add_column(u'farms_waterhistory', 'crop_season',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=4, to=orm['farms.CropSeason']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WaterHistory.crop_season'
        db.delete_column(u'farms_waterhistory', 'crop_season_id')
