...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for contact in orm.Contact_Info.objects.all():
            if contact.mobile is None or contact.mobile.strip() == '':
                continue
            smsInfo = orm.SMS_Info(number = contact.mobile.strip(), cuser_id = contact.cuser_id, muser_id = contact.muser_id)
            smsInfo.save()
            contact.sms_info = smsInfo
            contact.save()
