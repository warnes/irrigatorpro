...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact_Info.mobile'
        db.delete_column(u'contact_info_contact_info', 'mobile')


    def backwards(self, orm):
        # Adding field 'Contact_Info.mobile'
        db.add_column(u'contact_info_contact_info', 'mobile',
