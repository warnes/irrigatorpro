...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Contact_Info', fields ['sms_info']
        db.delete_unique(u'contact_info_contact_info', ['sms_info_id'])


        # Changing field 'Contact_Info.sms_info'
        db.alter_column(u'contact_info_contact_info', 'sms_info_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contact_info.SMS_Info'], null=True))
        # Adding unique constraint on 'SMS_Info', fields ['number']
        db.create_unique(u'contact_info_sms_info', ['number'])


    def backwards(self, orm):
        # Removing unique constraint on 'SMS_Info', fields ['number']
        db.delete_unique(u'contact_info_sms_info', ['number'])


        # Changing field 'Contact_Info.sms_info'
        db.alter_column(u'contact_info_contact_info', 'sms_info_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['contact_info.SMS_Info'], unique=True, null=True))
        # Adding unique constraint on 'Contact_Info', fields ['sms_info']
        db.create_unique(u'contact_info_contact_info', ['sms_info_id'])
    ...
    models = {
        ...
        u'contact_info.contact_info': {
            ...
            'sms_info': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contact_info.SMS_Info']", 'null': 'True', 'blank': 'True'}),
        ...
        u'contact_info.sms_info': {
            ...
            'number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20', 'blank': 'True'}),
