...
from farms.generate_water_register import earliest_register_to_update
from farms.models import CropSeason, Field
from datetime import date, datetime


# Test computaion of earliest to update. For expediency, hard-code field, crop-season on Alain's 
# server

print 'Performing query'
earliest_date = earliest_register_to_update(date(2014,07,03),
                                            CropSeason.objects.get(pk=19),
                                            Field.objects.get(pk=33))
