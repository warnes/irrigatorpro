...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationsRule.label'
        db.add_column(u'notifications_notificationsrule', 'label',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationsRule.label'
        db.delete_column(u'notifications_notificationsrule', 'label')
