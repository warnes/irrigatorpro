...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationsRule.delivery_time'
        db.add_column(u'notifications_notificationsrule', 'delivery_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5),
                      keep_default=False)

        # Adding field 'NotificationsRule.time_zone'
        db.add_column(u'notifications_notificationsrule', 'time_zone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationsRule.delivery_time'
        db.delete_column(u'notifications_notificationsrule', 'delivery_time')

        # Deleting field 'NotificationsRule.time_zone'
        db.delete_column(u'notifications_notificationsrule', 'time_zone')
